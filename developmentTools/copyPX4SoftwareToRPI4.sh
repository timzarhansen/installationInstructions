...
rsync -avh ~/Documents/PX4-Autopilot/boards/px4/fmu-v6x/ toptube@10.42.0.222:~/Documents/PX4-Autopilot/boards/px4/fmu-v6x/ --exclude=cmake-build-debug --exclude=build --exclude=.git --delete
